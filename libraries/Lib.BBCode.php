...
class BBCode {
  ...
  private static $simple_replace = array(
    ...
    '<a href="mailto:$1">$2</a>',
    '<a href="mailto:$1">$1</a>',
    '<div style="text-align: center"><img src="$1" alt="" /></div>',
    '<div style="text-align: center"><img height="$2" width="$1" alt="" src="$3" /></div>',
    '"<div style=\"text-align: center\"><img " . str_replace("&#039;", "\"",str_replace("&quot;", "\"", "$1")) . " src=\"$2\" /></div>"',   // we replace &quot; and &#039; to " in case if we got string converted to html entities
    ...
    "<div style=\"text-align: center\"><object width=\"425\" height=\"350\" style=\"text-align: center;\"><embed src=\"http://www.youtube.com/v/$1\" type=\"application/x-shockwave-flash\" width=\"425\" height=\"350\"></embed></object></div>",
    "<div style=\"text-align: center\"><embed src=\"http://video.google.com/googleplayer.swf?docId=$1\" type=\"application/x-shockwave-flash\" style=\"width: 425px; height: 350px;\"></div>",
  ...
  private static $lineBreaks_search = array(
    ...
    private static $lineBreaks_replace = array(
      ...
      "'[code]'.htmlspecialchars(str_replace('<br />', '', '$1')).'[/code]'",
      "[/code]",
  ...
  */
  public static function parse($string) {
   ...
   /*
    ARGUMENTS :
    $string = the text you want to remove tag
    */
    /*
      It is recomended to do $string = htmlentities($string) before calling parse
    */
    public static function notags($string)
    {
        ...
        $s = preg_replace(self::$simple_search, '', $s);
